...
-   `Popover`: A `variant` prop has been added to style popovers, with `'unstyled'` and `'alternate'` possible values ([#45137](https://github.com/WordPress/gutenberg/pull/45137)).

### Deprecations

-   `Popover`: The `isAlternate` prop has been replaced with a `variant` prop that can be called with the `'alternate'` string ([#45137](https://github.com/WordPress/gutenberg/pull/45137)).
